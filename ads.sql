...
-- Schema insurance
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `insurancedemo` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `insurancedemo` ;

-- -----------------------------------------------------
-- Table `insurance`.`insurance_company`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`insurance_company` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`product` (
  ...
  CONSTRAINT `R_107`
    ...
    REFERENCES `insurancedemo`.`insurance_company` (`Company_Name`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`customer` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`application` (
  ...
  CONSTRAINT `P_104`
    ...
    REFERENCES `insurancedemo`.`product` (`Product_Number`),
  CONSTRAINT `R_93`
    FOREIGN KEY (`Cust_Id`)
    REFERENCES `insurancedemo`.`customer` (`Cust_Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 74
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`claim` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`claim_settlement` (
  ...
  CONSTRAINT `R_90`
    ...
    REFERENCES `insurancedemo`.`claim` (`Claim_Id` , `Cust_ID`))
ENGINE = InnoDB
AUTO_INCREMENT = 4
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`coverage` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`department` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`incident` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`incident_report` (
  ...
  CONSTRAINT `FK_INCIDENT_ID`
    ...
    REFERENCES `insurancedemo`.`incident` (`Incident_Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 25
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`insurance_policy` (
  ...
  CONSTRAINT `R_95`
    ...
    REFERENCES `insurancedemo`.`application` (`Application_Id` , `Cust_Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 38
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`insurance_policy_coverage` (
  `Agreement_id` BIGINT NOT NULL AUTO_INCREMENT,
  `Application_Id` BIGINT NOT NULL,
  `Cust_Id` BIGINT NOT NULL,
  ...
  CONSTRAINT `R_97`
    ...
    REFERENCES `insurancedemo`.`insurance_policy` (`Agreement_id` , `Application_Id` , `Cust_Id`),
  CONSTRAINT `R_98`
    FOREIGN KEY (`Coverage_Id`)
    REFERENCES `insurancedemo`.`coverage` (`Coverage_Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 38
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`membership` (
...
-- Table `insurance`.`nok`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`nok` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`office` (
  ...
  CONSTRAINT `R_104`
    ...
    REFERENCES `insurancedemo`.`department` (`Department_Name`),
  CONSTRAINT `R_109`
    FOREIGN KEY (`Company_Name`)
    REFERENCES `insurancedemo`.`insurance_company` (`Company_Name`))
ENGINE = InnoDB
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`policy_renewable` (
  ...
  CONSTRAINT `R_101`
    ...
    REFERENCES `insurancedemo`.`insurance_policy` (`Agreement_id` , `Cust_Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`premium_payment` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`quote` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`receipt` (
  ...
  CONSTRAINT `R_84`
    ...
    REFERENCES `insurancedemo`.`premium_payment` (`Premium_Payment_Id` , `Cust_Id`))
ENGINE = InnoDB
AUTO_INCREMENT = 38
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`staff` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`vehicle` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `insurancedemo`.`vehicle_service` (
  `Department_Name` VARCHAR(100) NOT NULL,
  ...
  CONSTRAINT `R_50`
    ...
    REFERENCES `insurancedemo`.`department` (`Department_Name` , `Department_ID` , `Company_Name`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
TRIGGER `insurancedemo`.`createCoverage`
AFTER UPDATE ON `insurancedemo`.`application`
FOR EACH ROW
BEGIN
	DECLARE amount INT;
...
CREATE
DEFINER=`root`@`localhost`
TRIGGER `insurancedemo`.`updateRenewable`
AFTER UPDATE ON `insurancedemo`.`application`
FOR EACH ROW
BEGIN
	SET SQL_SAFE_UPDATES = 0;
...
CREATE
DEFINER=`root`@`localhost`
TRIGGER `insurancedemo`.`createClaimSettlement`
AFTER UPDATE ON `insurancedemo`.`claim`
FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`root`@`localhost`
TRIGGER `insurancedemo`.`createIncidentReport`
AFTER INSERT ON `insurancedemo`.`incident`
FOR EACH ROW
BEGIN
    DECLARE appId BIGINT;
...
CREATE
DEFINER=`root`@`localhost`
TRIGGER `insurancedemo`.`updateClaim`
AFTER UPDATE ON `insurancedemo`.`incident_report`
FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`root`@`localhost`
TRIGGER `insurancedemo`.`createPolicyCov`
AFTER INSERT ON `insurancedemo`.`insurance_policy`
FOR EACH ROW
BEGIN
...
CREATE
DEFINER=`root`@`localhost`
TRIGGER `insurancedemo`.`createReceipt`
AFTER INSERT ON `insurancedemo`.`premium_payment`
FOR EACH ROW
BEGIN
