...
CREATE TABLE INCIDENT_REPORT (
    ...
    Incident_Report_Status ENUM('ACCEPTED', 'PENDING') DEFAULT 'PENDING',
    Incident_Date DATE NOT NULL,
    ...
    CONSTRAINT FK_CUST_ID_2 FOREIGN KEY (Cust_Id) REFERENCES CUSTOMER (Cust_Id)
);
...
CREATE TABLE APPLICATION (
    ...
    Coverage_Level ENUM('HIGH', 'MEDIUM', 'LOW') DEFAULT 'HIGH',
    Cust_Id BIGINT NOT NULL,
    ...
    CONSTRAINT P_104 FOREIGN KEY (Product_Id) REFERENCES PRODUCT (Product_Number)
...
CREATE TABLE INSURANCE_POLICY (
    ...
    CONSTRAINT P_102 FOREIGN KEY (Policy_Number) REFERENCES PRODUCT (Product_Number)
);

CREATE UNIQUE INDEX XPKINSURANCE_POLICY_4 ON INSURANCE_POLICY (Agreement_id ASC, Application_Id ASC, Cust_Id ASC);
CREATE INDEX R_101 ON INSURANCE_POLICY (Agreement_id, Cust_Id);
...
CREATE TABLE POLICY_RENEWABLE (
    ...
    Cust_Id BIGINT NOT NULL,
    Policy_Renewable_Status ENUM('PENDING','RENEWED') DEFAULT 'PENDING',
    CONSTRAINT XPKPOLICY_RENEWABLE_16 PRIMARY KEY (Policy_Renewable_Id, Agreement_id, Cust_Id),
    CONSTRAINT R_101 FOREIGN KEY (Agreement_id, Cust_Id) REFERENCES INSURANCE_POLICY (Agreement_id, Cust_Id)
);

CREATE UNIQUE INDEX XPKPOLICY_RENEWABLE_16 ON POLICY_RENEWABLE (Policy_Renewable_Id ASC, Agreement_id ASC, NewApplication_Id ASC, Cust_Id ASC);
...
CREATE TABLE PREMIUM_PAYMENT (
    ...
    CONSTRAINT R_13 FOREIGN KEY (Application_Id, Cust_Id) REFERENCES APPLICATION (Application_Id, Cust_Id)
);
...
CREATE TABLE QUOTE (
    ...
    Coverage_Amount INT,
    Cust_Id BIGINT NOT NULL,
    CONSTRAINT XPKQUOTE_3 PRIMARY KEY (Quote_Id, Cust_Id),
    CONSTRAINT R_94 FOREIGN KEY (Cust_Id) REFERENCES CUSTOMER (Cust_Id)
);


CREATE UNIQUE INDEX XPKQUOTE_3 ON QUOTE (Quote_Id ASC, Cust_Id ASC);
...
CREATE TABLE COVERAGE (
    ...
    Coverage_Level VARCHAR(20) NOT NULL,
    Product_Id VARCHAR(20) NOT NULL,
    CONSTRAINT XPKCOVERAGE_19 PRIMARY KEY (Coverage_Id),
    CONSTRAINT P_101 FOREIGN KEY (Product_Id) REFERENCES PRODUCT (Product_Number)

);

CREATE UNIQUE INDEX XPKCOVERAGE_19 ON COVERAGE (Coverage_Id ASC);
...
CREATE TABLE INSURANCE_POLICY_COVERAGE (
    ...
    CONSTRAINT R_98 FOREIGN KEY (Coverage_Id) REFERENCES COVERAGE (Coverage_Id),
	CONSTRAINT R_80 FOREIGN KEY (Company_Name) REFERENCES INSURANCE_COMPANY (Company_Name)
